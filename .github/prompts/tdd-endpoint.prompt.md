...
1. Read the endpoint contract from [CLAUDE.md](../../CLAUDE.md) — find the request/response shapes, validation rules, status codes, and business logic
...
6. Follow conventions from CLAUDE.md: `{ data, error }` response shape, singleton Cosmos client, TypeScript
7. Run tests after each meaningful change
8. Iterate until ALL tests pass

## Phase 3: Review

9. Re-read the CLAUDE.md contract and verify the implementation matches every detail
